...
from quam_builder.architecture.superconducting.qubit.srf_transmon import SrfTransmon
...
__all__ = [
    ...
    *srf_transmon.__all__,
]

AnyTransmon = Union[BaseTransmon, FixedFrequencyTransmon, FluxTunableTransmon, SrfTransmon]
